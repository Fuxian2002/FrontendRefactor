...
Set-Location "D:\??????\??????1.0\https---github.com-Fuxian2002-StoreHouseMurasame-main\??????\code\PF2-web2\web2-vue"
...
Set-Location "D:\??????\??????1.0\https---github.com-Fuxian2002-StoreHouseMurasame-main\??????\code\PF2-web5\web5-vue"
Start-Process "npm.cmd" -ArgumentList "install" -Wait
Start-Process "npm.cmd" -ArgumentList "run dev"
