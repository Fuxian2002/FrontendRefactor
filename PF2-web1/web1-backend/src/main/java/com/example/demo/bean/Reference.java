...
//	private List<IntentPhenomenon> intentphenomenonList;	//intent/context现象列表
	public Reference(Reference item) {
		reference_no = item.reference_no;
		reference_name = item.reference_name;
		reference_description = item.reference_description;
//		reference_intentdescription = item.reference_intentdescription;
...
//		intentphenomenonList = item.intentphenomenonList;
		reference_x1 = item.reference_x1;
		reference_y1 = item.reference_y1;
		reference_x2 = item.reference_x2;
		reference_y2 = item.reference_y2;
...
//	public String getReference_intentdescription() {
//		return reference_intentdescription;
//	}
//
//	public void setReference_intentdescription(String reference_intentdescription) {
//		this.reference_intentdescription = reference_intentdescription;
//	}
