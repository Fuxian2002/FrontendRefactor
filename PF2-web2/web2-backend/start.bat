...
:: Configuration
set "PORT=7085"
set "JAR_PATH=target\web2-backend-0.0.1-SNAPSHOT.jar"
...
if not exist "%JAR_PATH%" (
    ...
    echo [HINT] Please ensure you are in web2-backend directory and have run maven build.
    pause
    exit /b 1
)

:: Start backend
echo [INFO] Starting web2-backend...
