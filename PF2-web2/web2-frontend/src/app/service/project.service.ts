...
export class ProjectService {
	...
	getReference(project: Project): Observable<RequirementPhenomenon[]>{
		const url = `http://localhost:7085/project/getReference`;
	...
	checkCorrectness(project: Project): Observable<Error[]> {
		const url = `http://localhost:7085/project/checkCorrectness`;
		return this.http.post<Error[]>(url, project, this.httpOptions);
	}

	checkCorrectContext(project: Project): Observable<Error[]> {
		const url = `http://localhost:7085/project/checkCorrectContext`;
		return this.http.post<Error[]>(url, project, this.httpOptions);
	}

	checkCorrectProblem(project: Project): Observable<Error[]> {
		const url = `http://localhost:7085/project/checkCorrectProblem`;
		return this.http.post<Error[]>(url, project, this.httpOptions);
	}

	checkWellFormed(project: Project): Observable<Error[]> {
		const url = `http://localhost:7085/project/checkWellFormed`;
		return this.http.post<Error[]>(url, project, this.httpOptions);
	}

	getSubProblemDiagram(project: Project): Observable<Project> {
		console.log(project)
		const url = `http://localhost:7085/project/getSubProblemDiagram`;
	...
	getBehIntList(project: Project, sgName: string): Observable<Phenomenon[]> {
		const url = `http://localhost:7085/project/getBehIntList/${sgName}`;
	...
	getExpIntList(project: Project, sgName: string): Observable<Phenomenon[]> {
		const url = `http://localhost:7085/project/getExpIntList/${sgName}`;
		return this.http.post<Phenomenon[]>(url, project, this.httpOptions);
	}

	// getPreIntList(project: Project, sgName: string): Observable<Phenomenon[]> {
	// 	const url = `http://localhost:7085/project/getPreIntList/${sgName}`;
	// 	return this.http.post<Phenomenon[]>(url, project, this.httpOptions);
	// }

	getIntList(project: Project, sgName: string): Observable<Phenomenon[]> {
		const url = `http://localhost:7085/project/getIntList/${sgName}`;
		return this.http.post<Phenomenon[]>(url, project, this.httpOptions);
	}

	getFullExpIntList(project: Project, sgName: string): Observable<Phenomenon[]> {
		const url = `http://localhost:7085/project/getFullExpIntList/${sgName}`;
		return this.http.post<Phenomenon[]>(url, project, this.httpOptions);
	}
	...
	// getScenarioGraph(userName: string, project: Project, projectName: string): Observable<Project> {
	// 	const url = `http://localhost:7085/project/getScenarioGraph?userName=${userName}&projectName=${projectName}`;
	// 	console.log(url)
	// 	return this.http.post<Project>(url, project, this.httpOptions);
	// }
	getScenarioGraph(project: Project, projectName: string, reqVersion): Observable<Project> {
		const url = `http://localhost:7085/project/getScenarioGraph?projectName=${projectName}&reqVersion=${reqVersion}`;
		return this.http.post<Project>(url, project, this.httpOptions);
	}

	getFullScenarioGraph(project: Project): Observable<Project> {
		const url = `http://localhost:7085/project/getFullScenarioGraph`;
		console.log(url, project);
		return this.http.post<Project>(url, project, this.httpOptions);
	}

	getBreakdownScenarioGraph(project: Project): Observable<Project> {
		const url = `http://localhost:7085/project/getBreakdownScenarioGraph`;
		console.log(url)
		return this.http.post<Project>(url, project, this.httpOptions);
	}

	getConnIntList(project: Project, sgName: string): Observable<Phenomenon[]> {
		const url = `http://localhost:7085/project/getConnIntList/${sgName}`;
		return this.http.post<Phenomenon[]>(url, project, this.httpOptions);
	}
