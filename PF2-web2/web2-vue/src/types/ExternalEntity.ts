...
export class ExternalEntity extends Node {
  ...
  static newExternalEntity(no: number, name: string, shortName: string, x: number, y: number, w: number, h: number) {
  ...
  static newExternalEntityWithOld(old: ExternalEntity, name: string, shortName: string) {
    let pd = new ExternalEntity();
  ...
  static copyExternalEntity(old: ExternalEntity) {
    let pd = new ExternalEntity();
    pd.externalentity_no = old.externalentity_no;
    pd.externalentity_x = old.externalentity_x;
    pd.externalentity_y = old.externalentity_y;
  ...
  getNo() { return this.externalentity_no; }
  setNo(no: number) { this.externalentity_no = no; }
  getName() { return this.externalentity_name; }
  setName(name: string) { this.externalentity_name = name; }
  getShortName() { return this.externalentity_shortname; }
  setShortName(shortName: string) { this.externalentity_shortname = shortName; }
  getX() { return this.externalentity_x; }
  setX(x: number) { this.externalentity_x = x; }
  getY() { return this.externalentity_y; }
  setY(y: number) { this.externalentity_y = y; }
  getH() { return this.externalentity_h; }
  setH(h: number) { this.externalentity_h = h; }
  getW() { return this.externalentity_w; }
  setW(w: number) { this.externalentity_w = w; }
}
